  ...
  foreach($inhalt as $nr => $post){
   ...
   $kunde[]              .= $post['kunde'];
      ...
      echo  '<link rel="stylesheet" href="style.css" type="text/css" />',
			'<a href="index.php?action=ladeTicket&amp;ticket_id='.$ticket_id[0].'&amp;rang='.$rang.'&amp;supporter='.$supporter.'">',
            '<table><thead>',
            '<tr>',
            '<th>Ticket_nr</th>',
            '<th>Kunde</th>',
...
<ul>
   <li><a href="index.php?controller=ticket&action=findeTicket&amp;rang=<?php echo $rang ?>&amp;supporter=<?php echo $supporter ?>">zurück zum Suchfeld</a>
   </li>
</ul>
